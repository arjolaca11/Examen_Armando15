...
public class ControlGastos {
    ...
    private int MAX_AMIGOS = 30;
    private int MAX_MOVS   = 300;
    ...
    public ControlGastos() {
        amigos = new Amigo[MAX_AMIGOS];
        movimientos = new Movimiento[MAX_MOVS];
        totalAmigos = 0;
        totalMovimientos = 0;
        cargarEjemploExamen(); // se carga automáticamente
    }
    ...
    // Resumen neto (por si lo quieres mostrar aparte)
    ...
    private void cargarEjemploExamen() {
        ...
        int idxJosua      = buscarIndicePorNombre("Joshua");
        ...
        agregarMovimiento("Cuenta 1 - Desayuno coffePrime", 120, idxGuillermo, new int[]{idxJosua,idxGreivin,idxGuillermo,idxAndres,idxTavo,idxDavid});
        agregarMovimiento("Cuenta 2 - Almuerzo Pig Factory", 200, idxGuillermo, new int[]{idxJosua,idxGreivin,idxGuillermo,idxAndres,idxTavo});
        agregarMovimiento("Cuenta 3 - Cena FastFood",         50, idxDavid,     new int[]{idxJosua,idxDavid});
        ...
        agregarMovimiento("Cuenta 6 - Apple store",           200, idxJosua,     new int[]{idxAndres});
        agregarMovimiento("Cuenta 7 - Desayuno Chillis",      150, idxGreivin,   new int[]{idxJosua,idxGreivin,idxGuillermo,idxAndres,idxTavo,idxDavid});
        agregarMovimiento("Cuenta 8 - Almuerzo Hooters",      180, idxTavo,      new int[]{idxJosua,idxGreivin,idxGuillermo,idxAndres,idxTavo,idxDavid});
    }
}
